/*
 * Copyright (c) 2013, Oracle and/or its affiliates. All rights reserved. ORACLE PROPRIETARY/CONFIDENTIAL. Use is
...
public final class Spliterators {
    ...
    static final class ArraySpliterator<T> implements Spliterator<T> {
        /**
         * The array, explicitly typed as Object[]. Unlike in some other classes (see for example CR 6260652), we do not
         * need to screen arguments to ensure they are exactly of type Object[] so long as no methods write into the
         * array or serialize it, which we ensure here by defining this class as final.
         */
         ...
         * @param additionalCharacteristics Additional spliterator characteristics of this spliterator's source or
         *            elements beyond {@code SIZED} and {@code SUBSIZED} which are always reported
         */
    ...
    public abstract static class AbstractSpliterator<T> implements Spliterator<T> {
         ...
         * @param additionalCharacteristics properties of this spliterator's source or elements. If {@code SIZED} is
         *            reported then this spliterator will additionally report {@code SUBSIZED}.
         */
         ...
         * {@inheritDoc}
         *
         * @implSpec This implementation returns the estimated size as reported when created and, if the estimate size
         *           is known, decreases in size when split.
         */
        @Override
        public long estimateSize() {
            return est;
    ...
    static final class IntIteratorSpliterator implements Spliterator.OfInt {
        ...
        /**
         * Creates a spliterator using the given iterator for a source of unknown size, reporting the given
         * characteristics.
         *
         * @param iterator the iterator for the source
         * @param characteristics properties of this spliterator's source or elements.
