...
public class CompletableFuture<T> implements Future<T>, CompletionStage<T> {
    ...
    static final class BiApply<T, U, V> extends BiCompletion<T, U, V> {
        ...
        final CompletableFuture<V> tryFire(int mode) {
            ...
            if ((d = dep) == null || (f = fn) == null || (a = src) == null || (r = a.result) == null
                || (b = snd) == null || (s = b.result) == null || !d.biApply(r, s, f, mode > 0 ? null : this))
                return null;
            dep = null;
            src = null;
            snd = null;
    ...
    static final class BiAccept<T, U> extends BiCompletion<T, U, Void> {
        ...
        final CompletableFuture<Void> tryFire(int mode) {
            ...
            if ((d = dep) == null || (f = fn) == null || (a = src) == null || (r = a.result) == null
                || (b = snd) == null || (s = b.result) == null || !d.biAccept(r, s, f, mode > 0 ? null : this))
                return null;
            dep = null;
            src = null;
            snd = null;
    ...
    static final class BiRun<T, U> extends BiCompletion<T, U, Void> {
        ...
        final CompletableFuture<Void> tryFire(int mode) {
            ...
            Runnable f;
            if ((d = dep) == null || (f = fn) == null || (a = src) == null || (r = a.result) == null
                || (b = snd) == null || (s = b.result) == null || !d.biRun(r, s, f, mode > 0 ? null : this))
                return null;
            dep = null;
            src = null;
            snd = null;
    ...
    static final class Signaller extends Completion implements ForkJoinPool.ManagedBlocker {
        ...
        public boolean isReleasable() {
            ...
            return ((interrupted && interruptible)
                || (deadline != 0L && (nanos <= 0L || (nanos = deadline - System.nanoTime()) <= 0L)) || thread == null);
        }
        ...
        return super.toString()
            + ((r == null) ? ((count == 0) ? "[Not completed]" : "[Not completed, " + count + " dependents]")
                : (((r instanceof AltResult) && ((AltResult)r).ex != null)
                    ? "[Completed exceptionally: " + ((AltResult)r).ex + "]" : "[Completed normally]"));
    }
